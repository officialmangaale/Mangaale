      ...
      <div className="mangaale-container mangaale-section">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-10">
            ...
            <h1 className="mt-6 text-4xl md:text-5xl leading-[1.1] mb-4">Privacy Policy</h1>
            <p className="text-sm text-mangaale-subtext">Last updated: March 15, 2026</p>
          </div>

          <p className="text-base leading-relaxed text-mangaale-text mb-12">
          ...
          <div className="space-y-10">
            <section>
              ...
              <ul className={listClass}>
                ...
                <li><strong>Verification documents and uploaded media:</strong> Aadhaar card, PAN card, FSSAI license, GST certificate, business logo, background images, menu or item images, and other files or images you choose to upload.</li>
                ...
                <li><strong>Customer and order-related information:</strong> order details, item selections, payment status, delivery information, invoice records, and related restaurant transaction data that is available to your restaurant account.</li>
                <li><strong>Location information:</strong> precise location may be collected when you grant permission so your restaurant can be placed accurately for location-based features such as nearby restaurant discovery and restaurant location updates.</li>
                <li><strong>Nearby device and Bluetooth information:</strong> the App may access Bluetooth and nearby device permissions to scan for and connect to compatible printers. On some Android versions, location permission may also be required by the operating system for printer discovery.</li>
                <li><strong>Notification data:</strong> push notification tokens and related messaging identifiers used to send order alerts and other important service notifications.</li>
            ...
            <section>
              <h2 className={sectionHeadingClass}>3. How We Share Information</h2>
              <p className="text-mangaale-text text-[15px] leading-relaxed mb-4">
              ...
              <ul className={listClass}>
                ...
                <li><strong>Your authorized users or staff</strong> within your restaurant account, based on the access you provide.</li>
                <li><strong>Legal or compliance disclosures</strong> when required by law, regulation, court order, or to protect rights, safety, and the integrity of the service.</li>
            ...
            <section>
              <h2 className={sectionHeadingClass}>5. Your Choices</h2>
              <ul className={listClass}>
            ...
            <section>
              <h2 className={sectionHeadingClass}>7. Children's Privacy</h2>
              <p className="text-mangaale-text text-[15px] leading-relaxed">
            ...
            <section>
              <h2 className={sectionHeadingClass}>8. Changes to This Policy</h2>
              <p className="text-mangaale-text text-[15px] leading-relaxed">
