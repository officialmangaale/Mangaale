 ...
 *
 * Terms, privacy policy and account deletion are pre-rendered HTML served ahead
 * of the SPA rewrite, so react-router has no route for them. A <Link> would
 * intercept the click, find nothing, and render the SPA's 404; a real <a href>
 * lets the browser fetch the pre-rendered document instead.
 *
